...
def upload_resume():
    """
    Accepts multipart form with 'file' (txt) OR JSON with 'text' field.
    Returns extracted skills + immediate matches (demo).
    """
    try:
...
def fetch_jobs_endpoint():
    """
    POST JSON { "skills": ["python","react"] } OR GET to use default demo skills.
    """
